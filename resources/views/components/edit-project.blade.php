                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-floating">
                            <input class="form-control form-control-sm" name="title" type="text"
                                value="{{ $projects->title }}" placeholder="Titolo *">
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="form-floating">
                            <input class="form-control form-control-sm" name="url" type="text"
                                value="{{ $projects->url_mappa }}" placeholder="URL *">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="tiny" class="form-control" name="note" rows="5">{{ $projects->note }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
                        @csrf
                        <input type="hidden" name="idproject" value="{{ $projects->idproject }}">
