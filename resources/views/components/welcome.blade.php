            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <div class="sidebar-card d-none d-lg-flex">
                        <img class="sidebar-card-illustration mb-2" src="{{ url('images/Logo GEOREDD_3.png') }}" alt="...">
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-7">
                                    <div class="card shadow mb-4">
                                        ...
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <iframe id="REDD" title="REDD" src="https://webgis.redd-realestate-data.com/it/map/pratiche_studio_delli_santi/?__bratk=0cac317bb288a3e4fc17f943f34b459f315702c9" width=100% height="600" frameborder="0" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <footer class="sticky-footer bg-white">
                        <div class="container my-auto">
                            ...
                            <div class="copyright text-center my-auto">
                                <span><a href="https://redd-realestate-data.com/" target="_blank">redd-realestate-data.com</a> &copy; Your Website 2024</span>
                            </div>
                            <div class="copyright text-center my-auto">
