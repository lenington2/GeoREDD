            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <div class="sidebar-card d-none d-lg-flex">
                        <img class="sidebar-card-illustration mb-2" src="{{ url('images/mondos.png') }}" alt="...">
                        <p class="text-center mb-2"><strong>GeoREDD</strong> Blah!...Blah!...Blah!...Blah!...</p>
                        <a class="btn btn-success btn-sm" href="/dashboard">Aggiornamento a Pro!</a>
                    </div>
